...
public class SphereTest {
    ...
    public void findIntsersections() {
        ...
        List<primitives.Point3D> result = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(-1, 0, 0),
        ...
        List<primitives.Point3D> resultTC03 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1, 0.5, 0),
        ...
        List<primitives.Point3D> resultTC04 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1, 1.5, 0),
                new primitives.Vector(0, 1, 0)));
        ...
        List<primitives.Point3D> resultTC11 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(0.4, 0.8, 0),
        ...
        List<primitives.Point3D> resultTC12 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1.6, 0.8, 0),
                new primitives.Vector(1, 0, 0)));
        ...
        List<primitives.Point3D> resultTC13 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(-1, 0, 0),
                new primitives.Vector(1, 0, 0)));
        ...
        List<primitives.Point3D> resultTC14 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(0, 0, 0),
                new primitives.Vector(1, 0, 0)));
        ...
        List<primitives.Point3D> resultTC15 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(0.5, 0, 0),
                new primitives.Vector(1, 0, 0)));
        ...
        List<primitives.Point3D> resultTC16 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1, 0, 0),
        ...
        List<primitives.Point3D> resultTC17 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1.8, 0.6, 0),
                new primitives.Vector(1, 0, 0)));
        assertEquals( 0, resultTC17.size(),"Wrong number of points");

        // TC18: Ray starts after sphere (0 points)
        List<primitives.Point3D> resultTC18 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(5, 0, 0),
                new primitives.Vector(1, 0, 0)));
        ...
        List<primitives.Point3D> resultTC19 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(2, -1, 0),
                new primitives.Vector(0, 1, 0)));
        assertEquals( 0, resultTC19.size(),"Wrong number of points");

        // TC20: Ray starts at the tangent point

        List<primitives.Point3D> resultTC20 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1, 1, 0),
                new primitives.Vector(1, 0, 0)));
        assertEquals( 0, resultTC20.size(),"Wrong number of points");

        // TC21: Ray starts after the tangent point
        List<primitives.Point3D> resultTC21 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(2, 1, 0),
                new primitives.Vector(1, 0, 0)));
        assertEquals( 0, resultTC21.size(),"Wrong number of points");

        // **** Group: Special cases
        // TC22: Ray's line is outside, ray is orthogonal to ray start to sphere's center line
        List<primitives.Point3D> resultTC22 = sphere.findIntersections(new primitives.Ray(new primitives.Point3D(1, 2, 0),
                new primitives.Vector(1, 0, 0)));
        assertEquals( 0, resultTC21.size(),"Wrong number of points");
    }
}
